      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <main className="mt-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <aside className="col-span-1 border-r border-[#E5E7EB] dark:border-[#4B5563] pr-4">
              <div className="mb-6">
              ...
              <div>
                <ul className="space-y-1 text-sm">
                  <li><a className="hover:underline" href="#">@TheDemystTimes</a></li>
                  <li><a className="hover:underline" href="#">Subscribe</a></li>
                </ul>
              </div>
            </aside>
            ...
            <div className="col-span-1 md:col-span-3">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  ...
                  <div className="border-t border-b border-[#E5E7EB] dark:border-[#4B5563] py-8">
                    <div className="text-center mb-6">
                      <span className="text-5xl font-display font-bold text-gray-400 dark:text-gray-500">NO. 01</span>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                      <div>
                        <h4 className="font-display text-xl font-bold">Story told by the Church Beadle</h4>
                      ...
                      <div>
                        <h4 className="font-display text-xl font-bold">The last day before Christmas</h4>
                        <p className="mt-2 text-sm">
                      ...
                      <div>
                        <h4 className="font-display text-xl font-bold">Noise and wonder at the end of Kiev</h4>
                        <p className="mt-2 text-sm">
